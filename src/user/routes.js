...
const { signUp, login, searchUser, changePassword } = require("./controllers"); // Import controllers from ./controllers
...
userRouter.post("/change-password", comparePass, hashPass, changePassword);
